          ...
          <div className="space-y-6">
            {messages.map((message) => {
              ...
              return (
                ...
                >
                  <div
                    className={`relative max-w-[80%] rounded-3xl border border-white/10 p-5 shadow-2xl backdrop-blur transition ${
                      isRight
                  ...
                  >
                    <div
                      className={`absolute top-4 flex h-10 w-10 items-center justify-center rounded-2xl text-xs font-semibold shadow-lg backdrop-blur ${
                        isRight
                    ...
                    >
                      <span
                        className={`font-semibold ${
                          isRight ? "text-neutral-900" : "text-white/80"
                        }`}
                      >
                        {message.speaker}
                      </span>
                      ...
                      {message.content.split("\n").map((line, idx) => (
                        <p
                          ...
                          className={`leading-relaxed ${
                            isRight ? "text-neutral-900" : "text-white/90"
                          }`}
                        >
                          {line}
                        </p>
