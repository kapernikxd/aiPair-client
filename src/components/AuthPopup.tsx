          ...
          >
            ...
            <div className="grid grid-cols-5 h-40 sm:h-48">
              ...
              <div className="absolute right-3 top-3">
                <Button onClick={onClose} variant="overlayClose" aria-label={t('auth.close', 'Close')}>
            ...
            <div className="px-6 pb-7 pt-6 sm:px-10 sm:pb-10 sm:pt-8">
              ...
              <div className="mx-auto mt-6 flex max-w-md flex-col gap-4">
                ...
                >
                  ...
                  {isGoogleLoading
                    ? t('auth.google.loading', 'Signing in with Google…')
                    : t('auth.google', 'Continue with Google')}
                </Button>

                {googleErrorMessage ? (
                  <p className="text-center text-sm text-red-400">{googleErrorMessage}</p>
                ) : null}

                {/* Apple */}
                <Button onClick={() => onApple?.()} variant="authProvider">
                ...
                >
                  ...
                  {t('auth.email', 'Continue with Email')}
                </Button>
              </div>
